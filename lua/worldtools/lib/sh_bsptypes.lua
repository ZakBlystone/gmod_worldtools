...
BSP.Readers[LUMP_TEXDATA_STRING_TABLE] = StructLump( LUMP_TEXDATA_STRING_TABLE, UINT32 ) --we don't ever need to load this

BSP.Readers[LUMP_OVERLAYS] = StructLump( LUMP_OVERLAYS, BSP.Overlay_t )

--Not implemented yet
BSP.Readers[LUMP_LEAFMINDISTTOWATER] = StructLump( LUMP_LEAFMINDISTTOWATER, UINT16 )
BSP.Readers[LUMP_FACE_MACRO_TEXTURE_INFO] = StructLump( LUMP_FACE_MACRO_TEXTURE_INFO, UINT16 )
...
BSP.Readers[LUMP_MAP_FLAGS] = StructLump( LUMP_MAP_FLAGS, UINT32 )
