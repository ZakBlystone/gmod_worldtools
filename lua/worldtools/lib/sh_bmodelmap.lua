...
module( "wt_bmodelmap", package.seeall )
...
hook.Add("InitPostEntity", "wt_bmodelmap_init", function()
	mapAll()
end )

hook.Add("OnReloaded", "wt_bmodelmap_init", function()
	mapAll()
end )
...
hook.Add("OnEntityCreated", "wt_bmodelmap_created", function(ent)
	mapEntity(ent)
end )
hook.Add("OnEntityRemoved", "wt_bmodelmap_removed", function(ent)
	unmapEntity(ent)
end )
